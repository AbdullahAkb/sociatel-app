...
//       var data = chatsData[i].data() as Map<String, dynamic>;
//       var user_data = widget.chatUser.tojson();
//       var _data = data["receiverUser"];
//       if (_data["uid"] == user_data["uid"]) {
//         ChatModel chats =
//             ChatModel.fromDocumentSnapshot(snapshot: chatsData[i]);
//         chatList.add(chats);
//       }
//     }
//     yield chatList;
